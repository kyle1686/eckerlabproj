...
# Paths:
image_save_path = "/home/user300/Project_Folder/Google_Drive/Image_Holder/C3_Calibration/Tray8_Calibration" # Change this to desired directory - GOOGLE DRIVE!
...
def copy_to_drive():
    try:
        subprocess.run(
            ["rclone", "copy", paths.cr_t8_calibimage_save_path, paths.cr_gdrive_calibration_path],
            check=True
        )
        print(f"Successfully copied {paths.cr_t8_calibimage_save_path} → {paths.cr_gdrive_calibration_path}")
