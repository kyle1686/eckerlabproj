...
# Paths:
image_save_dir = "/home/user300/eckerlabproj/Jupyter_Lab/WorkingVersion/Desktop_Version/Image_Holder/Temp_Staging_Area" # Change this to temporary staging directory
possible_types_path = "/home/user300/eckerlabproj/Jupyter_Lab/WorkingVersion/Desktop_Version/Image_Capture" # Change this to where the possible genotypes and stress list for the plates we're working with is
